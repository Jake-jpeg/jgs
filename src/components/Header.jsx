      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            <MobileNavItem href="/about">The Builder</MobileNavItem>
            <MobileNavItem href="/projects">Products</MobileNavItem>
          </ul>
        </nav>
      </PopoverPanel>
    </Popover>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        <NavItem href="/about">The Builder</NavItem>
        <NavItem href="/projects">Products</NavItem>
      </ul>
    </nav>
  )
}
...
function Avatar({ large = false, className, ...props }) {
  return (
    ...
    >
      <div
        className={clsx(
          'flex items-center justify-center rounded-full bg-teal-500 font-bold text-white dark:bg-teal-400 dark:text-zinc-900',
